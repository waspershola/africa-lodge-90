-- Fix search_path security warnings for atomic functions

-- Update calculate_reservation_overstay with search_path
...
-- Update atomic_checkin_guest with search_path
