...
-- Create supplies for housekeeping (using general categories)
...
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'::uuid, '44444444-4444-4444-4444-444444444444'::uuid, 'Toilet Paper', 'cleaning', 'rolls', 50, 10, 100, 150.00, true),
...
-- Create initial users (these will be created via Supabase Auth manually)
-- Super Admin User
