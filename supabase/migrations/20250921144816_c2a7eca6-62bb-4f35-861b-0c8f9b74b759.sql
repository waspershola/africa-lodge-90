-- First, clean up any existing hotel role templates
DELETE FROM public.role_permissions 
WHERE role_id IN (
  SELECT id FROM public.roles 
  WHERE name IN ('HOTEL_OWNER', 'HOTEL_MANAGER', 'FRONT_DESK', 'HOUSEKEEPING', 'MAINTENANCE', 'POS_STAFF', 'ACCOUNTANT', 'SECURITY', 'EVENT_MANAGER', 'MARKETING', 'IT_ADMIN') 
