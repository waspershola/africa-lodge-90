...
const navigationItems = [
  {
    title: 'Dashboard',
    href: '/support-admin/dashboard',
    icon: LayoutDashboard,
  },
  {
    title: 'Tenants Overview',
    href: '/support-admin/tenants',
    icon: Building2,
  },
  {
  ...
  {
    title: 'Impersonation',
    href: '/support-admin/impersonation',
    icon: UserCog,
  },
  {
    title: 'Plans & Billing',
    href: '/support-admin/billing',
    icon: CreditCard,
  },
  {
    title: 'Add-ons Catalog',
    href: '/support-admin/addons',
    icon: Package,
  },
  {
    title: 'Reports',
    href: '/support-admin/reports',
    icon: BarChart3,
  },
  {
    title: 'Settings',
    href: '/support-admin/settings',
    icon: Settings,
  },
];
...
export default function SupportAdminLayout() {
  ...
  const SidebarContent = () => (
    <div className="flex h-full flex-col overflow-y-auto bg-gradient-to-b from-amber-50 to-amber-100 dark:from-amber-950 dark:to-amber-900 px-3 py-4">
      <div className="flex items-center gap-2 px-4 py-2 mb-6">
        <Crown className="h-8 w-8 text-amber-600 dark:text-amber-400" />
        <div>
          <h1 className="text-xl font-bold text-amber-900 dark:text-amber-100">Support Console</h1>
          <p className="text-xs text-amber-700 dark:text-amber-300">Global Administrator</p>
        </div>
      </div>
            ...
            <Link
              ...
              className={`group flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-colors ${
                isActive
                  ...
                  : 'text-amber-700 hover:bg-amber-100 hover:text-amber-900 dark:text-amber-300 dark:hover:bg-amber-800 dark:hover:text-amber-100'
              }`}
